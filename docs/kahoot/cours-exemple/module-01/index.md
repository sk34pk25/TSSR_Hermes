...
| Propriété | Valeur |
|---|---|
| Kahoot ID | `3f60f90a-7967-4b3b-a67f-f1b696af3065` |
| Nombre de questions | 3 |
| Notions couvertes | systèmes de fichiers, commandes Linux |
| Statut | synchronisé |
...
<div class="tssr-kahoot-embed">
  <iframe class="tssr-kahoot-embed__iframe"
    src="https://embed.kahoot.it/3f60f90a-7967-4b3b-a67f-f1b696af3065"
    title="Kahoot — Cours exemple — Module 01"
    loading="lazy"
    allowfullscreen>
  </iframe>
</div>
